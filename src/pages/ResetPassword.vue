<template>
  <div class="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center p-6">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
      ...
      <div v-if="!tokenPresent" class="p-4 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-800 mb-4">
        Lien invalide ou token manquant. Veuillez relancer la procédure de réinitialisation depuis la page « Mot de passe oublié ».
      </div>
...
<style scoped>
/* ajustements mineurs pour le bouton si besoin */
</style>
