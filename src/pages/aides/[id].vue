  ...
  <LayoutDefault>
    <div class="mb-10">
      <div class="mb-10 flex justify-center">
        <div
          class="w-full max-w-3xl bg-Bleu rounded-2xl px-6 py-4 shadow-md hover:shadow-lg hover:scale-[1.01] transition-all cursor-pointer relative overflow-hidden"
          :style="aide.imageCard ? { backgroundImage: `url('${pb.getFileUrl(aide, aide.imageCard)}')` } : {}"
        >
          <div
            ...
            >
              <div class="flex items-center justify-between w-full min-w-0">
                <div class="flex items-center gap-3 md:gap-4 min-w-0">
                  ...
                  <h3
                    class="font-bold text-gray-800 text-base md:text-lg break-words leading-tight"
                  >
                    {{ etape.titre }}
                  </h3>
                </div>
