    ...
    <section class="rounded-2xl bg-Bleu text-Blanc p-6 m-4 ml-0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 w-full">
        ...
        <div class="relative group">
          <RouterLink
            to="/annuaire"
            class="bg-Blanc text-Bleu font-bold font-permanent-marker text-lg md:text-sm rounded-2xl p-4 md:p-6 lg:p-4 flex items-center justify-center hover:scale-105 transition-transform duration-300 shadow-md w-full h-full min-h-[80px] md:min-h-[200px]"
          >
            ANNUAIRE
          </RouterLink>
        </div>
